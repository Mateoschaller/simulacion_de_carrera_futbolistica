...
def amarillas(club,jugadores_sancionados,equipo_player,valoracion_player,nombre_jugador):
    def get_random_player6(jugadores,weigth):
        if weigth == 7:
            weights7 = [0.14, 0.14, 0.14, 0.14, 0.14, 0.14,0.14]           
            return random.choices(jugadores, weights=weights7)[0]
    ...
    amarillas = []
    while (contador == lat):
        e1player = ["Martinelli","Gabriel Jesus","Trossard","Saka","Odegaard"]
        e2player = ["Coutinho","Watkins","Ramsey","Buendía"]
        e3player = ["Semenyo","Solanke","Lerma","Christie"]
        e4player = ["Toney","Mbeumo","Schade","Ghoddos"]
        e5player = ["MacAllister","Welbeck","Mitoma","Enciso","Undav"]
        e6player = ["Félix","Havertz","Sterling","Fernandez","Pulisic"]
        e7player = ["Zaha","Ayew(cp)","Milivojevic","Edouard"]
        e8player = ["Doucouré","McNeil","Calvert-Lewin","Maupay"]
        e9player = ["Mitrovic","Willian","Cairney","Reid"]
        e10player = ["Greenwood","Moreno","McKennie","Bamford"]
        e11player = ["Vardy","Maddison","Barnes","Iheanacho"]
        e12player = ["Salah","Firmino","Núñez","Luis Díaz","Diogo Jota"]
        e13player = ["Haaland","Foden","Mahrez","Álvarez","Grealish"]
        e14player = ["Rashford","Sancho","Bruno Fernandes","Martial","Weghorst"]
        e15player = ["Isak","Guimarães","Joelinton","Saint-Maximin","Murphy"]
        e16player = ["Awoniyi","Gibbs-White","Ayew","Danilo"]
        e17player = ["Adams","Alcaraz","Ward-Prowse","Edozie"]
        e18player = ["Kane","Richarlison","Son","Lucas Moura","Kulusevski"]
        e19player = ["Antonio","Paquetá","Benrahma","Ings"]
        e20player = ["Diego Costa","Cunha","Adama Traoré","Sarabia"]
        e21player = ["Tella","Hedilazio","Rodríguez","Barnes"]
        e22player = ["Ndiaye","McBurnie","Sharp","Brewster"]
        e23player = ["Morris","Adebayo","Woodrow","Muskwe"]
        e24player = ["Muniz","Akpom","Archer","Forss"]
        e25player = ["Godden","Walker","Tavares","Bapaga"]
        e26player = ["Diallo","Stewart","Gelhardt","Gooch"]
        e27player = ["Ben Brereton Díaz","Gallagher","Vale","Hedges"]
        e28player = ["Bradshaw","Burey","Watmore","Burke"]
        e29player = ["Dike","Wallace","Diangana","Phillips"]
        e30player = ["Piroe","Whittaker","Cooper","Cullen"]
        e31player = ["Pedro","Davis","Sarr","Martins"]
        e32player = ["Delap","Parrott","Riis","Cannon"]
        e33player = ["Pukki","Sara","Gibbs","Dowell"]
        e34player = ["Wells","Cornick","Bell","Conway"]
        e35player = ["Estupiñan","Ebiowei","Tetteh","Connolly"]
        e36player = ["Brown","Campbell","Powell","Gayle"]
        e37player = ["Hogan","Graham","Chong","Hannibal"]
        e38player = ["Hungbo","Knockaert","Ward","Kamberi"]
        e39player = ["Ojo","Robinson","Harris","Wickham"]
        e40player = ["Dykes","Adomah","Willock","Roberts"]
        e41player = ["Messi","Mbappe","Neymar","Pereira","Sanches"]
        e42player = ["Lacazette","M.Dembele","Sarr(O.L)","Tolisso","Tagliafico"]
        e43player = ["Martinez","Lukaku","Mkhitaryan","Calhanoglu","Dzeko"]
        e44player = ["Di Maria","Kean","Chiesa","Milik","Vlahovic"]
        e45player = ["Giroud","Leão","Ibrahimovic","Tonali","B.Diaz"]
        e46player = ["Osimhen","Raspadori","Simeone","Lozano","Kvaratskhelia"]
        e47player = ["Dybala","Belotti","El Shaarawy","Pellegrini","Wijnaldum"]
        e48player = ["Griezmann","Morata","de Paul","Koke","Lemar"]
        e49player = ["Lewandowski","Gavi","Fati","Raphinha","O.Dembélé"]
        e50player = ["Benzema","Vinicius","Rodrygo","Modric","Tchouameni"]
        e51player =["Haller","Moukoko","Bellingham","Reus","Reyna"]
        e52player = ["Gnabry","Mané","Müller","Musiala","Sané"]
        e53player = ["Diaby","Azmoun","Wirtz","Adli","Hlozek"]
        e54player = ["Taremi","Galeno","Evanilson","Folha","Grujic"]
        e55player = ["Paulinho","Trincao","Edwards","Santos","Gomes"]
        e56player = ["Götze","Muani","Borre","Alario","Lindstrom"]
        e57player = ["Payet","Sánchez","Harit","Ünder","Gueye"]
        e58player = ["Dolberg","En-Nesyri","Suso","Gomez","Lamela"]
        e59player = ["Neres","Rafa","Ramos","Musa","Aursnes"]
        e60player = ["Silva","Werner","Forsberg","Olmo","Nkunku"]
        e61player = ["Tadic","Kudus","Conceição","Bergwijn","Ocampos"]
        e62player = ["Ben Yedder","Volland","Embolo","Seghir","Camara"]
        e63player = ["Traore","Sikan","Petryak","Kryskiv","Bondarenko"]
        e64player = ["Sowah","Nusa","Jutglà","Onyedika","Vanaken"]
        e65player = ["de Jong","Bakayoko","Simons","Veerman","F.Silva"]
        e66player = ["Illarramendi","Navarro","Karrikaburu","Kubo","Guevara"]
        e67player = ["Immobile","Milinkovic-Savic","Pedro(L)","Basic","Lazzari"]
        e68player = ["Muriel","Zapata","Hojlund","Colombo","Pasalic"]
        e69player = ["N.Gonzalez","Arthur","Jovic","Sottil","Kouamé"]
        e70player = ["Arnautovic","Sansone","Orsolini","Raimondo"]
        e71player = ["Pellegri","Radonjic","Sanabria","Vlasic"]
        e72player = ["Petagna","Ciurria","Maric","Gytkjær"]
        e73player = ["Deulofeu","Nestorovski","Ebosele","Beto"]
        e74player = ["Berardi","Lauriente","Pinamonti","Ceide"]
        e75player = ["Satriano","Cambiaghi","Piccoli","Destro"]
        e76player = ["Botheim","Piatek","Bonazzoli","Maggiore"]
        e77player = ["Ceesay","Persson","Corfitzen","Oudin"]
        e78player = ["Gaich","Djuric","Braaf","Ngonge"]
        e79player = ["Nzola","Krollis","Shomurodov","Gyasi"]
        e80player = ["Ciofani","Buonaiuto","Dessers","Okereke"]
        e81player = ["Quagliarella","Gabbiadini","Montevago","Ivanovic"]
        e82player = ["Moro","Garritano","Bolocs","Gelli"]
        e83player = ["Yalcin","Puscas","Badelj","Coda"]
        e84player = ["Esposito","Cheddira","Maita","Maiello"]
        e85player = ["Vázquez","Juric","Benedyczak","Mihaila"]
        e86player = ["Lapadula","Pavoletti","Pereiro","Zito"]
        e87player = ["Mazzocchi","Odogwu","Tait","Belardinelli"]
        e88player = ["Canotto","Majer","Fabbian","Strelec"]
        e89player =["Johsen","Zampano","Tessmann","Pohjanpalo"]
        e90player = ["Tutino","Brunori","Buttaro","Segre"]
        e91player = ["Armellino","Diaw","Giovannini","Gerli"]
        e92player = ["Sibili","Torregrossa","Tramoni","Nagy"]
        e93player = ["Gondo","Forte","Dionisi","Caligara"]
        e94player = ["Cutrone","Gabrielloni","Vigna","Cerri"]
        e95player = ["Favili","Falletti","Partipilo","Proietti"]
        e96player = ["Aye","P.Rodriguez","Bisoli","Listkowski"]
        e97player = ["Magrassi","Ambrosino","Antonucci","Danzi"]
        e98player = ["Nasti","Voca","Florenzi","Brescianini"]
        e99player =["Di Carmine","Di Serio","Luperini","Vulic"]
        e100player = ["Rabbi","Moncini","Celia","Rauti"]
        e101player = ["Ciano","Farias","Karic","Foulon"]
...
def asistentes(club,goles,jugadores_sancionados,equipo_player,valoracion_player,nombre_jugador):
    def get_random_player6(jugadores,weigth):
        if weigth == 7:
            weights7 = [0.14, 0.14, 0.14, 0.14, 0.14, 0.14,0.14]           
            return random.choices(jugadores, weights=weights7)[0]
...
def rojas(club,jugadores_sancionados,equipo_player,valoracion_player,nombre_jugador):
    def get_random_player6(jugadores,weigth):
        if weigth == 7:
            weights7 = [0.14, 0.14, 0.14, 0.14, 0.14, 0.14,0.14]            
            return random.choices(jugadores, weights=weights7)[0]
...
def goleadores(club,goles,jugadores_sancionados,equipo_player,valoracion_player,nombre_jugador):
    def get_random_player6(jugadores,weigth):
        if weigth == 7:
            weights7 = [0.30, 0.20, 0.15, 0.10, 0.10, 0.10, 0.5]             
            return random.choices(jugadores, weights=weights7)[0]
